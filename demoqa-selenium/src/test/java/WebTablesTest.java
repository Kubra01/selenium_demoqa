...
public class WebTablesTest extends BaseTest {
    ...
    public void addNewRecordTest(){
        ...
        webTablesPage
                ...
                .createNewRecord("Kubra" , "Saglam", "kubra123@gmail.com" ,
                        "26", "2500","Tech");
        Assertions.assertTrue(webTablesPage.webTable().checkRow("Kubra","Saglam",
                "kubra123@gmail.com",
                "26","2500", "Tech"));
    }
    ...
    public void editRowTest(){
        WebTablesPage webTablesPage = new WebTablesPage(driver);
        webTablesPage.webTable().editRow("1" , "Kubra");
        Assertions.assertEquals("Kubra", webTablesPage.webTable().getRowValues(1).get(0), "Edit failed!");
    }
